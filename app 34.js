...
function layoutAfterSplit(sourcePose, poseById, sourceId, modelA, modelB, axis) {
  ...
  // pair.left / modelA is keepMin=true in splitBothSides. rawClip treats
  // keepMin true as coord >= plane (the HIGH / right side on X).
  // Seat that half to the RIGHT of the cut, low side to the LEFT.
