...
function flipSelected() {
  ...
  // Apply rotations in a stable order: flip around local X, keep yaw
  p.mesh.rotation.set(p.flipX ? Math.PI : 0, p.rotY || 0, 0);
  ...
  // Refresh white outline on new orientation
  if (p.outline) {
    p.mesh.remove(p.outline);
