...
function buildPlateMesh() {
  ...
  const grid = new THREE.GridHelper(Math.max(p.w, p.d), 18, 0x4a4e56, 0x35383e);
...
function seatFlushBitToHull() {
  ...
  setStatus('Seated on skin - bit crosses wall, then Subtract');
}
